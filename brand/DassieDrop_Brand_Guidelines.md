**Modern local sharing with a distinctly Southern African identity.**
...
| Colour       | Hex      | Usage                                                         |
|--------------|----------|---------------------------------------------------------------|
| Navy Primary | \#061A3A | Main branding colour. Represents trust, stability, security.  |
| Deep Blue    | \#0B2E63 | Used for active UI elements and highlights.                   |
| Slate Grey   | \#5B6472 | Neutral supporting colour for surfaces and secondary content. |
| Soft White   | \#F7F9FC | Background colour to maintain clarity and simplicity.         |
